...
- **Clone & Fetch**: Clones a Git repository and fetches the `refs/gittuf/policy` branch using go-git.
...
- **CORS Support**: Built-in CORS middleware support via gin-contrib/cors.
